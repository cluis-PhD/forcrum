...
export function CourseManagement({ onBack, onNavigate }: CourseManagementProps) {
  ...
  // Função para carregar cursos do Neon
  ...
  // Função para arquivar curso no Neon
            ...
            <div className="space-y-3">
              {filteredCourses.map((course) => (
                <div
                  ...
                  className="bg-white rounded-[16px] p-3.5 shadow-sm hover:shadow-md transition-all border-2 border-transparent hover:border-[#4aa540] cursor-pointer"
                >
                  {/* Header */}
                  <div className="mb-3">
                    <div className="flex items-center gap-2 mb-1.5">
                      <h3 className="text-[16px] text-slate-800 leading-tight">{course.name}</h3>
                      <span className={`${getStatusColor(course.status)} px-2 py-0.5 rounded-[6px] text-[10px]`}>
                        {getStatusLabel(course.status)}
                      </span>
                    </div>
                    <p className="text-[13px] text-slate-500 leading-snug mb-1.5">{course.description}</p>
                  ...
                  <div className="grid grid-cols-2 gap-2 mb-3">
                    <div className="bg-blue-50 rounded-[10px] p-2.5 flex items-center gap-2">
                      <div className="bg-blue-100 p-1.5 rounded-[6px]">
                        <Users size={14} className="text-blue-600" />
                      </div>
                      <div>
                        <p className="text-[10px] text-slate-500 leading-none mb-0.5">Formandos</p>
                        <p className="text-[16px] text-slate-800 font-semibold leading-none">{getStudentCount(course.id)}</p>
                      </div>
                    </div>
                    <div className="bg-purple-50 rounded-[10px] p-2.5 flex items-center gap-2">
                      <div className="bg-purple-100 p-1.5 rounded-[6px]">
                        <Target size={14} className="text-purple-600" />
                      </div>
                      <div>
                        <p className="text-[10px] text-slate-500 leading-none mb-0.5">Equipas</p>
                        <p className="text-[16px] text-slate-800 font-semibold leading-none">{getTeamCount(course.id)}</p>
                      </div>
                    </div>
                    <div className="bg-orange-50 rounded-[10px] p-2.5 flex items-center gap-2">
                      <div className="bg-orange-100 p-1.5 rounded-[6px]">
                        <Layers size={14} className="text-orange-600" />
                      </div>
                      <div>
                        <p className="text-[10px] text-slate-500 leading-none mb-0.5">Sprints</p>
                        <p className="text-[16px] text-slate-800 font-semibold leading-none">{getSprintCount(course.id)}</p>
                      </div>
                    </div>
                    <div className="bg-green-50 rounded-[10px] p-2.5 flex items-center gap-2">
                      <div className="bg-green-100 p-1.5 rounded-[6px]">
                        <FileText size={14} className="text-green-600" />
                      </div>
                      <div>
                        <p className="text-[10px] text-slate-500 leading-none mb-0.5">Stories</p>
                        <p className="text-[16px] text-slate-800 font-semibold leading-none">{getStoryCount(course.id)}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mb-3">
                    <div className="flex items-center justify-between mb-1">
                      ...
                      <p className="text-[12px] text-slate-800 font-medium">{course.progress}%</p>
                    </div>
                  ...
                  <button
                    ...
                    className="w-full py-2 px-3 border-2 border-slate-200 text-slate-700 rounded-[10px] text-[13px] hover:bg-slate-50 transition-colors flex items-center justify-center gap-1.5"
                  >
                    <Trash2 size={14} />
                    Eliminar
                  </button>
